...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 2) {
    // Nếu role không tồn tại hoặc không phải là 2, chuyển hướng người dùng đi
...
<body >
    ...
    <div class="TD">
        <h1>Đội Trưởng Câu Lạc Bộ Tin Học</h1>
    </div>
    
    <div class="Lich">
        <h1><a href="">Quy Tắc</a> <hr color="aqua" size="6px" ></h1> 
        <h2><a href="">Lịch Hoạt Động </a> <hr color="aqua" size="6px" ></h2> 
        <h3><a href="captain.php">Thành Viên</a> <hr color="aqua" size="6px" ></h3> 
        <h4><a href="">Đơn Xin Tham Gia</a> <hr color="aqua" size="6px" ></h4> 
    </div>
